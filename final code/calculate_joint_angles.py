...
from defs import loadmat, make_joint_origins, make_segcos, make_jointangles
########################################################################################################################

########################################################################################################################
input_path = '/opt/DATA/mat/'
outputs_path = '/opt/DATA/npy/jointangles/'
...
for file in files:
    ...
    jointangles = make_jointangles(segmentcos)

    np.save(outputs_path + name, jointangles)
print('Finished')